...
public class pressLeftButton : MonoBehaviour
{
    ...
    void Update()
    {
        if(pressed) {
        	...
        	playerTransform.RotateAround(Vector3.zero, Vector3.down, 60*Time.deltaTime);
        	origineTransform.RotateAround(Vector3.zero, Vector3.down, 60*Time.deltaTime);
        	leftBallTransform.RotateAround(Vector3.zero, Vector3.down, 60*Time.deltaTime);
        	rightBallTransform.RotateAround(Vector3.zero, Vector3.down, 60*Time.deltaTime);
        }
    }
